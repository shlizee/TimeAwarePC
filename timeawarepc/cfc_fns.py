...
def val_pc_hsic_btp(data_trans,alpha):
    from pcalg import estimate_skeleton, estimate_cpdag, hsic_condind, causaleff_ida, ci_test_gauss
    import networkx as nx
    (g, sep_set) = estimate_skeleton(indep_test_func=hsic_condind,
                                        data_matrix=data_trans,
                                        alpha=alpha,method='stable')
...
def val_pc_gauss_btp(data_trans,alpha):
    from pcalg import estimate_skeleton, estimate_cpdag, causaleff_ida, ci_test_gauss, ci_test_gauss_btp
    import networkx as nx
...
def val_neuropc_lin(data,lag=1,subsampsize=50,n_iter=1,alpha=0.3,thresh=0.25,v2=False):
    ...
    import numpy as np
    import pandas as pd
    from pcalg import data_transformed, data_transformed_overlapping, causaleff_ida, return_finaledges, estimate_cpdag, estimate_skeleton,ci_test_gauss, orient
    #import rpy2.robjects as robjects
    #from rpy2.robjects.packages import importr
    #import rpy2.rlike.container as rlc
    #from rpy2.robjects import pandas2ri
...
def val_tpc_sno(data,lag=1,alpha=0.1):
    ...
    import numpy as np
    import pandas as pd
    from pcalg import data_transformed_overlapping,data_transformed,return_finaledges_v2 ,estimate_cpdag, estimate_skeleton, ci_test_gauss,causaleff_ida, return_finaledges
    import random
    import networkx as nx
    start_time = time.time()
...
def val_tpc_sno_nogaps(data,lag=1,alpha=0.1):
    ...
    import numpy as np
    import pandas as pd
    from pcalg import data_transformed_nogaps,data_transformed,return_finaledges_v2 ,estimate_cpdag, estimate_skeleton, ci_test_gauss,causaleff_ida, return_finaledges
    import random
    import networkx as nx
    start_time = time.time()
...
def val_tpc_sno_mod(data,lag=1,alpha=0.1):
    ...
    import numpy as np
    import pandas as pd
    from pcalg import data_transformed_overlapping,data_transformed_mod,return_finaledges_v2 ,estimate_cpdag, estimate_skeleton, ci_test_gauss,causaleff_ida, return_finaledges
    import random
    import networkx as nx
    start_time = time.time()
    p = data.shape[1]
...
def val_tpc_sno_hsic_btp(data,lag=1,alpha=0.1):
    ...
    import numpy as np
    import pandas as pd
    from pcalg import data_transformed_overlapping,hsic_condind,data_transformed,return_finaledges_v2 ,estimate_cpdag, estimate_skeleton, ci_test_gauss,causaleff_ida, return_finaledges
    import random
    import networkx as nx
    start_time = time.time()
    data_trans = data_transformed(data, lag-1)
...
def val_tpc_sno_btp(data,lag=1,alpha=0.1):
    ...
    import numpy as np
    import pandas as pd
    from pcalg import data_transformed_overlapping,data_transformed,return_finaledges_v2 ,estimate_cpdag, estimate_skeleton, ci_test_gauss,causaleff_ida, return_finaledges, ci_test_gauss_btp
    import random
    import networkx as nx
    start_time = time.time()
    data_trans = data_transformed(data, lag-1)
...
def val_tpc_sno_btstrp(data,lag=1,alpha=0.1):
    ...
    import numpy as np
    import pandas as pd
    from pcalg import data_transformed_btstrp,data_transformed,return_finaledges_v2 ,estimate_cpdag, estimate_skeleton, ci_test_gauss,causaleff_ida, return_finaledges
    import random
    import networkx as nx
    start_time = time.time()
...
def val_tpc_ns(data,lag=1,subsampsize=50,n_iter=50,alpha=0.3,thresh=0.25):
    ...
    import numpy as np
    import pandas as pd
    from pcalg import data_transformed,estimate_skeleton,return_finaledges_v2,estimate_cpdag,ci_test_gauss,data_transformed_overlapping, causaleff_ida, return_finaledges, orient
    import rpy2.robjects as robjects
    from rpy2.robjects.packages import importr
    import rpy2.rlike.container as rlc
    from rpy2.robjects import pandas2ri
...
def val_tpc_ns_hsic_btp(data,lag=1,subsampsize=50,n_iter=50,alpha=0.3,thresh=0.25):
    ...
    import numpy as np
    import pandas as pd
    from pcalg import data_transformed,hsic_condind,estimate_skeleton,return_finaledges_v2,estimate_cpdag,ci_test_gauss,data_transformed_overlapping, causaleff_ida, return_finaledges, orient
    import rpy2.robjects as robjects
    from rpy2.robjects.packages import importr
    import rpy2.rlike.container as rlc
    from rpy2.robjects import pandas2ri
...
def val_tpc_ns_btp(data,lag=1,subsampsize=50,n_iter=50,alpha=0.3,thresh=0.25):
    ...
    import numpy as np
    import pandas as pd
    from pcalg import data_transformed,estimate_skeleton,return_finaledges_v2,estimate_cpdag,ci_test_gauss,data_transformed_overlapping, causaleff_ida, return_finaledges, orient,ci_test_gauss_btp
    import rpy2.robjects as robjects
    from rpy2.robjects.packages import importr
    import rpy2.rlike.container as rlc
    from rpy2.robjects import pandas2ri
...
def val_neuropc(data,lag=1,subsampsize=50,n_iter=1,alpha=0.3,thresh=0.25,v2=False):
    ...
    import numpy as np
    import pandas as pd
    from pcalg import data_transformed,data_transformed_overlapping, causaleff_ida, return_finaledges, orient
    import rpy2.robjects as robjects
    from rpy2.robjects.packages import importr
    import rpy2.rlike.container as rlc
    from rpy2.robjects import pandas2ri
